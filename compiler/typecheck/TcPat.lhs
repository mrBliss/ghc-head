...
data TcSigInfo
  = TcSigInfo {
        ...
        sig_extra  :: Maybe TcTyVar, -- A meta var that will be unified with
                                     -- the extra constraints that may be
                                     -- inferred. Is Nothing when no
                                     -- extra-constraints wildcard was present
                                     -- in the type signature.

        sig_wanted :: WantedConstraints,
                                    -- Constraints captured while typechecking
                                    -- the type signature. These constraints
                                    -- can only be generated by holes in a
